...
const createTiles = (width) => mapFull((isMine, index) => ({
  index,
...
export const getAdjacentTiles = curry(({ width, height, tiles }, tile) => flow(
...
const updateAdjacentMineCount = (width, height) => mapFull((tile, _, tiles) => ({
  ...tile,
